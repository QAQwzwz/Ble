...
import com.srtianxia.bleattendance.ui.teacher.dataanalysis.DataAnalysisFragment;
...
//        tvCurrentCourse.setText(getPrefixText() + getText(R.string.current_course_no_choose));
    ...
    private void initFragment() {
        ...
        getSupportFragmentManager().beginTransaction()
                ...
                .add(R.id.fragment_container, mDataAnalysisFragment)
                .show(mDataAnalysisFragment)
                .hide(mTeacherScanFragment)
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.bottom_nav_scan:
                ...
                getSupportFragmentManager().beginTransaction()
                        .hide(mAttendanceFragment).hide(mCourseContainerFragment).hide(mDataAnalysisFragment)
...
//                toolbar.setVisibility(View.INVISIBLE);
            ...
            case R.id.bottom_nav_table:
                mToolbar.setVisibility(View.VISIBLE);
                getSupportFragmentManager().beginTransaction()
                        .hide(mTeacherScanFragment).hide(mAttendanceFragment).hide(mDataAnalysisFragment)
            ...
            case R.id.bottom_nav_analytics:
                mToolbar.setVisibility(View.VISIBLE);
                getSupportFragmentManager().beginTransaction()
                        .hide(mTeacherScanFragment).hide(mAttendanceFragment).hide(mCourseContainerFragment)
                        .hide(mTeaBeforeAttendanceFragment).show(mDataAnalysisFragment)
                        .commit();
                if (mFabMenu.isOpened())
                    closeFabMenu();
